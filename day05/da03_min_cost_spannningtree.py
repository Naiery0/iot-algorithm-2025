# da03_min_cost_spannningtree.py
# 최소비용 신장 트리
...
def findVertex(g, findVtx):
    ...
    while len(stack) != 0:
        ...
        for vertex in range(SIZE):
            if g.graph[current][vertex] != 0: # 간산이 있다
...
# 가중치별 간선 내림차순 정렬
# itemgetter(0) => (weight, slot, elot) weight로 정렬하겠다.
