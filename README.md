...
- 자료구조 / 알고리즘
    - 그래프: [노트북](./day05/da01_graph.ipynb)
        ...
        - 최소비용 신장트리: [파이썬](./day05/da03_min_cost_spannningtree.py)
...
https://github.com/user-attachments/assets/2728a35f-303e-4b77-a910-65e352c1d22a
...
- 자료구조/알고리즘
    - 정렬
        ...
        <img src="./image/cupdog_BW.png" width="600">
